...
class dbConnect
{
    ...
    public function __construct($dbname = 'blog', $username = 'Zhenia', $password = 'PassWord09', $host = 'localhost')
    {
        try{
    ...
    {
        $query = $this->db->prepare("CREATE TABLE $tableName (id int unsigned auto_increment primary key,
